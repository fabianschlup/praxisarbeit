...
class User(PaginatedAPIMixin, UserMixin, db.Model):
    ...
    todos = db.relationship('Todo', foreign_keys='Todo.user_id', backref='creator', lazy='dynamic')
    assigned_todos = db.relationship('Todo', foreign_keys='Todo.assigned_to_id', backref='assignee', lazy='dynamic')
    ...
    def assigned_todos(self):
        return self.todos.order_by(Todo.due_date.desc())
